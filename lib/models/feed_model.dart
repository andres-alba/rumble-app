...
class Datum {
    ...
    factory Datum.fromJson(Map<String, dynamic> json) => Datum(
        ...
        authorAvatarExtension: authorAvatarExtensionValues.map[json["author_avatar_extension"]],
    ...
    Map<String, dynamic> toJson() => {
        ...
        "author_avatar_extension": authorAvatarExtensionValues.reverse![authorAvatarExtension],
...
final authorAvatarExtensionValues = EnumValues({
    "png": AuthorAvatarExtension.PNG
});
